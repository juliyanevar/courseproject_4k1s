...
const api = axios.create({
  baseURL: process.env.REACT_APP_API + "attendance/",
});
...
function Attendance() {
  var columns = [
    ...
    { title: "Auditorium", field: "auditoriumName" },
    { title: "Teacher", field: "teacherUsername" },
    { title: "Student", field: "studentUsername" },
  ];
